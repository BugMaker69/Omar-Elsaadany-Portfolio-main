...
class AppConstants {
  ...
  static String get devName => _info['name'] ?? 'Omar Elsaadany';
  ...
  // Social Links
  static String get githubUrl => _info['github'] ?? 'https://github.com/BugMaker69';
  static String get linkedinUrl =>
      _info['linkedin'] ?? 'https://www.linkedin.com/in/omar-elsaadany2002/';
  static String get email => 'mailto:${_info['email'] ?? 'omarmohammedelsaadany@gmail.com'}';
  ...
  static String get phoneCallUrl => 'tel:${_info['phone'] ?? '+201120107040'}';
}
